    ...
    void Update()
    {
        ...
        ReadOnlySpan<Entry> entries = new ReadOnlySpan<Entry>(
            new Entry[]
            {
                ...
                new Entry("Stick Left", ButtonToString(ArcadeInput.Players[PlayerID].Left.Held), PaddingLength),
                new Entry("Stick Right", ButtonToString(ArcadeInput.Players[PlayerID].Right.Held), PaddingLength),
                new Entry("Stick Down", ButtonToString(ArcadeInput.Players[PlayerID].Down.Held), PaddingLength),
                new Entry("Stick Up", ButtonToString(ArcadeInput.Players[PlayerID].Up.Held), PaddingLength),
